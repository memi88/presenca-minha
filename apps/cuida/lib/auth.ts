...
// Mesmo D1/mesma configuração de auth do Presença (packages/db) — um
// profissional (Cuida) e um paciente (Presença) são a mesma tabela de
// usuário do Better Auth, só distinguidos por `profissionais.user_id`.
declare global {
